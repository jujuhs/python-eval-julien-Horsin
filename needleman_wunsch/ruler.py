...
class Ruler:
    ...
    def choix_mat(self, S): # permet de définir la matrice dans le cas simple où toutes les substitutions ont le même cout
        if S == "":
    ...
    def __init__(self, str1, str2, d=1, S="", remplacement_cost=1, insert_cost=1):
        ...
        self.d = d #coût d'un espace ("=")
        self.remplacement_cost = remplacement_cost #on définit la valeur de la distance liée à 
        self.insert_cost = insert_cost #on définit la distance liée à un gap
        self.mat=self.choix_mat(S) #on définit la matrice des coûts de substituion entre les lettres
    ...
    def cout_sub(self, x, y): # cette méthode renvoie les couts liée à la subsitution des lettres 'x' et 'y'
